...
cli peer lifecycle chaincode install -n vehicle-manufacture -v $1 -p /opt/gopath/src/github.com/chaincode -l node
...
-e "CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/org2.example.com/users/Admin@org2.example.com/msp" \
-e "CORE_PEER_TLS_ROOTCERT_FILE=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/org2.example.com/peers/peer0.org2.example.com/tls/ca.crt" \
cli peer lifecycle chaincode query -C mychannel -n vehicle-manufacture -c '{"Args":["queryVehicle","4567788:Prius"]}' >> logs.txt
sleep 10
...
echo "successfully upgraded smart contract"
